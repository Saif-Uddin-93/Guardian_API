...
# mock iam client
# @pytest.fixture()
# def iam_client_fixture(aws_credentials):
#     with mock_aws():
#         role_id, role_arn = create_iam_role('test-iam', boto3.Session().client("iam"))
#         yield sts_assume_role(role_arn, sts_client_fixture.client("sts"))
